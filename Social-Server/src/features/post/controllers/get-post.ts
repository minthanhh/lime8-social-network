...
export class Get {
  public async posts(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Tất cả bài đăng', posts, totalPosts });
  }
  public async postsWithImages(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Tất cả bài đăng có hình ảnh', posts });
  }
  public async postsWithVideos(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Tất cả bài đăng có video', posts });
  }
}
